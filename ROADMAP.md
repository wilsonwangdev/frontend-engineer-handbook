...
| CI 的 e2e job 暂关闭（push/PR 不跑），原因：runner 上 chromium 代理拦截 localhost | 2026-05-20   | —                                                                  | 见 [journal/2026-05-20-e2e-proxy-on-ci.md](journal/2026-05-20-e2e-proxy-on-ci.md) |
