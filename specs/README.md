...
| [0014](0014-taste-cultivation-for-beginners/spec.md)    | 为初学者培养品位               | accepted | 写章节遇到设计判断时；触发对照 / 反思 / 命名反模式 / 透明化         |
| [0015](0015-top-level-navigation/spec.md)               | 顶级导航与公共页面入口         | proposed | 新增公共页面（非章节路由）时；header / 抽屉怎么加入口               |
| [0016](0016-playground-system/spec.md)                  | 整站 Playground 集中页系统     | proposed | 写新 demo / 评估 demo 是章节内嵌还是 Playground 集中时              |
| [0017](0017-glossary-evolution/spec.md)                 | 术语表维护方案演化路径         | proposed | 给 terms.yaml 加新术语时检查触发条件；术语 ≥ 30 时启动迁移          |
| [0018](0018-search-implementation-strategy/spec.md)     | 站内搜索实现策略               | accepted | 为什么自建而非 FlexSearch / Pagefind；触发重评估的三条定量条件      |
| [0019](0019-chapter-completion-review/spec.md)          | 章节完成后的定位复核与经验积累 | accepted | 每章完结后 3 问复核 + journal；第 5 章写作教训触发                  |
