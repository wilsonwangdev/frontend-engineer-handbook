...
> 权威参考：[TypeScript Handbook: Differences Between Type Aliases and Interfaces](https://www.typescriptlang.org/docs/handbook/2/objects.html#interfaces-vs-intersections)（英文）；[Declaration Merging](https://www.typescriptlang.org/docs/handbook/declaration-merging.html)（英文）。
...
> 权威参考：[TypeScript Handbook: Enums](https://www.typescriptlang.org/docs/handbook/enums.html)（英文，含官方对 enum 的"建议"）；[TypeScript issue #202: const enums in isolated modules](https://github.com/microsoft/TypeScript/issues/202)（英文，社区讨论）。
...
> 权威参考：[Zod 官方](https://zod.dev/)；[Valibot 官方](https://valibot.dev/)。
...
> 权威参考：[TypeScript: verbatimModuleSyntax](https://www.typescriptlang.org/tsconfig#verbatimModuleSyntax)（英文）。
