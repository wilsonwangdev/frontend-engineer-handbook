...
> 一手：[HTML 规范：事件循环处理模型](https://html.spec.whatwg.org/multipage/webappapis.html#event-loop-processing-model)（英文，权威规范）。
...
> 涉及**Web Workers**（让 CPU 密集任务跑在另一个线程）的话题留给第 8 章前沿话题。本章只讨论"标准单线程 + 异步 IO"。
...
> 一手：[MDN: Promise](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Promise)。
...
> 一手：[MDN: Promise.all](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Promise/all) / [Promise.allSettled](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Promise/allSettled) / [Promise.race](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Promise/race) / [Promise.any](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Promise/any)。
...
> 一手：[TC39: top-level await proposal](https://github.com/tc39/proposal-top-level-await)。
...
> 一手：[MDN: async function](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Statements/async_function) / [MDN: await](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Operators/await)。
...
> 一手：[MDN: Microtask 指南](https://developer.mozilla.org/zh-CN/docs/Web/API/HTML_DOM_API/Microtask_guide)；[MDN: queueMicrotask](https://developer.mozilla.org/zh-CN/docs/Web/API/Window/queueMicrotask)；[HTML 规范：事件循环处理模型](https://html.spec.whatwg.org/multipage/webappapis.html#event-loop-processing-model)。
...
> 一手：[MDN: AbortController](https://developer.mozilla.org/zh-CN/docs/Web/API/AbortController)；[MDN: for await...of](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Statements/for-await...of)。
