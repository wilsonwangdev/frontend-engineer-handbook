...
> 一手：[MDN: let](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Statements/let)；[MDN: const](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Statements/const)；[MDN: var](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Statements/var)。
...
> 深入：[Dan Abramov: A Complete Guide to useEffect](https://overreacted.io/a-complete-guide-to-useeffect/) **（英文）**——React 核心维护者写的闭包陷阱权威解释。这是少数值得读完的"个人博客"，按 [SPEC-0002](https://github.com/wilsonwangdev/frontend-engineer-handbook/blob/main/specs/0002-content-source-admission/spec.md) 灰名单条款引用。
...
> 一手：[MDN: 闭包](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Closures)。
...
> 一手：[PortSwigger: Prototype Pollution](https://portswigger.net/web-security/prototype-pollution)（英文，权威安全指南）；[npm advisory: lodash prototype pollution](https://github.com/advisories/GHSA-jf85-cpcp-j695)。
...
> 一手：[MDN: 继承与原型链](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Inheritance_and_the_prototype_chain)。
...
> 一手：[MDN: this](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Operators/this)；[MDN: 箭头函数](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Functions/Arrow_functions)。
...
> 一手：[MDN: 严格模式](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Strict_mode)。

---

## 6. 函数高级

JavaScript 把**函数当作"一等公民"**——函数可以像普通值一样传递、赋值、返回。这是 JS 函数式风格的根基。
...
- [Dan Abramov: A Complete Guide to useEffect](https://overreacted.io/a-complete-guide-to-useeffect/) **（英文）** — React 核心维护者写的闭包陷阱权威解释（按 SPEC-0002 灰名单条款引用）
